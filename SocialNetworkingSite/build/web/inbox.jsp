    ...
    <body>
        ...
        <%
          ...
          //  PreparedStatement pstmt = con.prepareStatement("select user_id,msg_content,msg_date from message_record where to_user=? and flag=?");
                PreparedStatement pstmt = con.prepareStatement("select  ud.first_name,ud.last_name,mr.msg_content,mr.msg_date,mr.msg_id from user_details ud , message_record mr where ud.user_id = mr.user_id and mr.to_user=?  order by mr.msg_date desc");
        ...
        <%
               while (rs.next()) {%><tr><%
                Integer msgid=rs.getInt("msg_id");        //for (int i = 1; i <= col; i++) {
            ...
            <% String url="Messagedel?delmsg="+unm+"&msgid="+msgid;  %>
        ...
        <td><h4><a href=<%=url%>> delete</a></h4><td>
            ...
            <%
               ...
               // String updateMessage = "update message_record set flag='1' where flag='0'";
                ...
                //pstmt1.setString(1,rs.getString("0"));        
