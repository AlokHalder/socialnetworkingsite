<%-- 
    Document   : Profile
    Created on : Mar 31, 2013, 11:31:57 AM
...
<html>
	...
	<div id="templatemo_wrapper">
        ...
        <%@ include file="template/menu1.jsp" %>
        ...
        <div id="templatemo_content_wrapper">
            ...
            <div class="templatemo_sidebar_wrapper float_l">
              ...
              enctype="multipart/form-data">    
                   <%@ include file="template/leftupper.jsp" %>
                     </form>
                  <%@ include file="template/leftbox.jsp" %>
            ...
            <div id="templatemo_content">
                ...
                <div id="banner">
                    <a href="http://www.templatemo.com/preview/templatemo_173_store" target="_parent"><img src="img/fr2.jpg" alt="banner" width="540" height="120"/></a>                
                </div>
             ...
             <textarea name="t1" rows="2" cols="50"></textarea><br>
              ...
              <div class="product_box margin_r20">
                		...
                		<%@ include file="template/postshow.jsp" %>
            ...
            <div class="templatemo_sidebar_wrapper float_r">
                ...
                <div class="templatemo_sidebar">
                 ...
                 <%@ include file="template/rightbox.jsp" %>	
