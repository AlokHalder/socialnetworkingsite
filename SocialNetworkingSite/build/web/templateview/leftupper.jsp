...
<html>
    ...
    <body>
        <div class="sidebar_box">
            <% DBconnection dbConl1 = new DBconnection();
                        ...
                        try {
                            ...
                            String username = (String) ses1.getAttribute("friendid");*/
                            String username=request.getParameter("friendid");
                            if (conl1 == null) {
       ...
       <div class="sidebar_box_content">
                  <%
                  String uid =request.getParameter("friendid");
...
<% } %>
           ...
           <%-- <a href="#"><img src="<%= session.getAttribute("username") %>/<%= session.getAttribute("profilePic") %>" alt="<%= session.getAttribute("username")%>" width="160" height="120" /></a>--%>
                          ...
                          <p></p>
                           ...
                           <div class="discount"><span></span>  <a href="#"></a></div>
