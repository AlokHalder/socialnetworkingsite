...
<html>
    ...
    <body>
          <div class="sidebar_box">
                    ...
                    <li><h4>Works In :<%= works%></h4></li>
                    <li><h4>Designation :<%=desig%></h4></li>
                    <li><h4>Current Location :<%=livesin%></h4></li>
                    <li><h4>From :<%=address%></h4></li>
                    <li><h4>Graduation School :<%=grad%></h4></li>
                    <li><h4>Passout Year :<%=gradyr%></h4></li>
                    <li><h4>Sex :<%=sex%></h4></li>
                    <li><h4>Date of Birth :<%=dob%></h4></li>
                    <li><h4>Email :<%=email%></h4></li>
                    <li><h4>Relationship Status :<%=relation%></h4></li>
                    <li><h4>Favourite Quote :<%=quote%></h4></li>
